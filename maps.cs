...
namespace LlamaLibrary
{
    public class TreasureMap
    {
        static TreasureMap()
        {
            ...
            CurrentMap = patternFinder.Find("Search 48 8d 0d ?? ?? ?? ?? e8 ?? ?? ?? ?? 48 8d 0d ?? ?? ?? ?? 0f b7 d8 e8 ?? ?? ?? ?? Add 3 TraceRelative");
        ...
        /// </summary>
        private static IntPtr CurrentMap;
        /// <summary>
        /// Provides a KeyItem => TreasureHuntRank lookup because the client does the same thing.
        /// </summary>
        private static Dictionary<uint, short> MapPrimary = new Dictionary<uint, short>
        {
        ...
        public static short SecondaryKey => Core.Memory.Read<short>(CurrentMap);
    }
}
